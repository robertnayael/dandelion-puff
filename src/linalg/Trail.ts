...
export class Trail {
  ...
  public update(): this {
    ...
    if (this.isDisplacementLargeEnough(this.speed)) {
      this.displacements = [...this.displacements, this.speed];
    }
  ...
  private isDisplacementLargeEnough(candidate: Vector2): boolean {
    return true;
  }
}
